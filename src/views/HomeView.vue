        ...
        .then(data => {
          ...
          for (let i = 0; i < data.restaurantList.length; i++) {
            ...
            if (data.restaurantList[i].published == true) {
              this.restaurant1AreaArr.push(data.restaurantList[i])
            }
          }
          // console.log(this.restaurant1AreaArr);
        })
    },
    //  美食分頁
    changePage(offset) {
...
<template>
  ...
  <div v-if="page == 2" class="mapByMyself" ref="mapPlace">
    <div class="left">
        ...
        <svg class="mySvg" version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg"
          ...
          <g>
            ...
            <path class="st6"
              d="M765,520.1c-0.9,0-1.8,0.4-2.4,1c-0.6,0.6-1,1.5-1,2.4c0,0.9,0.4,1.8,1,2.4c0.6,0.6,1.5,1,2.4,1
          ...
          <g class="st1 island" @click="svgMoveLeft('凍骨冰山島')" id="island3" data-message="凍骨冰山島" data-content="冰山島好好玩">
            ...
            <path class="st15"
              d="M497.1,406.1c-0.7,1.8-2,2.4-3.9,2.4c-22.4,0-44.8,0-67.2,0c-0.3,0-0.6,0-1,0c-0.8-0.1-1.4-0.6-1.3-1.4
            ...
            <path class="st15"
              d="M432.5,350.7c-0.5-0.5-0.8-0.8-1.2-1.2c-0.2-0.2-0.5-0.4-0.7-0.7c-0.3-0.4-0.8-0.8-0.8-1.3
          ...
          <g class="st1 island" @click="svgMoveLeft('慢活樂園島')" id="island4" data-message="慢活樂園島" data-content="樂園島好好玩">
            ...
            <path class="st18"
              d="M616.8,235.9c1.8,0.6,2.5,1.4,2.5,2.9c0,2-1.1,3.6-2.8,4.2c-3.1,1.1-6.2-1.4-5.8-4.6
          ...
          <g class="st1 island" @click="svgMoveLeft('驚險火山島')" id="island5" data-message="驚險火山島" data-content="火山島好好玩">
            ...
            <path class="st20"
              d="M566.4,396.4l185.3,12c-1.6,5.7-3.4,11.5-5.4,17.1c-5,14-14.3,35.8-30.4,60.4c-9.6,14.7-14.5,22.1-23.2,30.9
            ...
            <path class="st21"
              d="M632.5,475.1c0,1.7,0,3.4,0,5.1c0,0.9-0.4,1.3-1.2,1.3c-0.7,0-1.1-0.5-1.2-1.3c0-1.7,0-3.4,0-5.1
    ...
    <div class="right" ref="mapRightPlace">
      ...
      <div class="uniqueMap">
        <div class="uniqueMapLeft">
          ...
          <svg v-if="this.islandName == '孤島'" version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 841.9 595.3"
            style="enable-background:new 0 0 841.9 595.3;" xml:space="preserve">
            <g>
              <defs>
              ...
              <path class="alonest0"
                d="M373.6,412.4c-10,0-25-1.8-39-10.3c-38.7-23.5-52.6-87.7-28.2-129.6c16.2-27.8,46.1-39.4,60.5-45
              ...
              <path class="alonest1"
                d="M443.7,220.5c12.2,0,22.9,1.5,33.6,4.7c17.3,5.2,35.1,10.6,41.2,22.3c15.2,29.3-44.6,89.4-80.3,125.3
          ...
          <svg v-if="this.islandName == '凍骨冰山島'" version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 841.9 595.3"
            style="enable-background:new 0 0 841.9 595.3;" xml:space="preserve">
            <g>
              <defs>
                <path id="SVGID_1_"
                  d="M212.8,274.7c12.9-3.8,26.5-5.9,40.2-5.9c49.9,0,96.3,27.1,121.1,70.4l29.1,51.4c2.4,3.6,6.1,5.9,10.5,5.9
              ...
              <path class="icest2" d="M303.9,181.1c0.8,0.3,1.1,0.9,1.1,1.7c0,1.2,0,2.5,0,3.8c0.2-0.1,0.3-0.2,0.4-0.3c1-0.7,2-1.5,3-2.2
                          ...
                          H303.9z" />
              <path class="icest2"
                d="M515.9,252.4c-1.4,3.7-4.1,4.9-7.9,4.8c-45.3-0.1-90.5,0-135.8,0c-0.6,0-1.3,0-1.9,0c-1.6-0.1-2.7-1.3-2.7-2.7
          ...
          <svg v-if="this.islandName == '刺激飛天島'" version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 841.9 595.3"
            style="enable-background:new 0 0 841.9 595.3;" xml:space="preserve">
            <g>
              <defs>
              ...
              <path class="flyst1"
                d="M507.7,45.8c4.2,0,8.7,1.1,12.5,3c5.6,2.9,11.8,4.8,18,5.6l16.9,395.9l-83.3,28.2
          ...
          <svg v-if="this.islandName == '驚險火山島'" version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 841.9 595.3"
            style="enable-background:new 0 0 841.9 595.3;" xml:space="preserve">
            <g>
              <defs>
              ...
              <path class="firest0"
                d="M305.4,511.6c-7.4,0-28.3-0.7-61.7-7.1c-6.9-1.3-19.6-3.8-26.2-13.6c-2.1-3.2-3.5-6.9-4-11.2l25.1-382.4
              ...
              <path class="firest2"
                d="M410.5,301.9c0,4.3,0,8.6,0,12.9c0,2.2-1.1,3.4-2.9,3.4c-1.8,0-2.9-1.2-2.9-3.4c0-4.3,0-8.6,0-12.9
                          c0-4.2,0-8.5,0-12.7c0-2.4,1-3.6,2.8-3.7c1.9-0.1,3,1.2,3,3.7C410.5,293.4,410.5,297.6,410.5,301.9" />
              <path class="firest2"
                d="M437.1,159.7c-1,0.2-1.9,0.1-2.9-0.2c-5.3-1.6-10.5-1.6-15.7,0.4c-1.2,0.5-1.9,0.4-2.7-0.8
          ...
          <svg v-if="this.islandName == '溫馨親子島'" version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 841.9 595.3"
            style="enable-background:new 0 0 841.9 595.3;" xml:space="preserve">
            <g>
              <defs>
              ...
              <path class="childst0"
                d="M311.9,484.8l-14.2-336.9c7.9-2.1,15.4-6.1,21.9-11.7L401,68.5c4.8-4,11-6.1,17.4-6.1c3.2,0,6.3,0.5,9.3,1.6
              ...
              <path class="childst2"
                d="M415.4,374.7v-68.2c-1.9,0.8-3.9,1.2-5.9,0.7c-2-0.5-3.6-1.7-4.8-3.2c-4.6,5-10.5,4.1-13.8,0
          ...
          <svg v-if="this.islandName == '慢活樂園島'" version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 841.9 595.3"
            style="enable-background:new 0 0 841.9 595.3;" xml:space="preserve">
            <g>
              <defs>
                <path id="SVGID_1_"
                  d="M330.3,136.4c-6.4,4.3-14.8,9-25.6,12.1c-10.8,3.1-18.5,3-20.5,3.3c-12.4,1.8-24,49.5-23.3,240.3l63.2,1.5
              ...
              <path class="heavenst0"
                d="M330.8,474.2l4.7-70c0.2-3.2-0.9-6.3-3-8.8c-2.3-2.4-5.4-3.8-8.6-3.8l-61.1-1.5
              ...
              <path class="heavenst2"
                d="M445,250.4c-0.9,2.4-2.7,3.3-5.2,3.2c-4.6-0.1-9.2-0.1-13.8,0c-2.2,0-4.1-0.4-5-2.6c-0.8-1.9,0.1-4.6,1.9-6.2
              ...
              <path class="heavenst2"
                d="M335.3,275.9c1.2-2.5,1.3-2.5,5.4-3.1c0.6-2.1,1.1-4.3,1.7-6.4c0.4-1.2,0.9-2.3,1.4-3.5
              ...
              <path class="heavenst2"
                d="M399.5,250.4c1.1-1.4,2.6-1.6,4.3-1.5c1.1,0,2.1,0,3.2,0c2.1,0.1,3.7,1.7,3.7,3.8c0.1,3.2-1.8,5.7-4.9,6.4
              ...
              <path class="heavenst2"
                d="M353.7,250.1c3.7-3,8-5.3,12.8-6.7c0.2-0.1,0.5-0.1,0.7-0.2c1-0.2,1.9,0.3,2.2,1.2c0.2,0.9-0.2,1.7-1.2,2.1
              ...
              <path class="heavenst2"
                d="M345.4,296.8c-1.2-3-2.4-6-3.6-9c-0.1-0.3-0.2-0.5-0.2-0.8c-0.2-1,0.3-1.9,1.2-2.2c0.9-0.3,1.7,0.2,2.1,1.2
              ...
              <path class="heavenst2"
                d="M408.8,272.8c-0.7-2.3-1.4-4.7-2.2-7c-0.2-0.5-0.5-1-0.6-1.6c-0.3-1,0-1.9,0.8-2.2c0.9-0.4,1.9-0.1,2.3,0.9
              ...
              <path class="heavenst2"
                d="M376.5,237c0.5,0,1,0,1.5,0c2.6-0.2,5.1,1.6,4.3,5.4c-0.6,3.2-3.7,5.3-6.9,4.8c-3.3-0.6-5.5-3.7-5-6.9
              ...
              <path class="heavenst2"
                d="M412.6,242.8c0,1-0.8,1.8-1.7,1.8c-1,0-1.7-0.9-1.7-1.9c0-1,0.8-1.7,1.8-1.7C412,241,412.7,241.8,412.6,242.8" />
  ...
  <div v-if="page == 6" class="limitedEdition ">
    <h1>周邊商品
      <img src="https://upload.wikimedia.org/wikipedia/zh/6/60/Mario_Kart_Blue_Shell.png" alt="">
    </h1>
...
.limitedEdition {
  ...
  h1 {
    ...
    img {
      height: 10vh;
      width: 5vw;
      animation: run 4s infinite steps(10000);
    }
  }
