                ...
                <el-col :span="12">
                    ...
                    <el-menu active-text-color="#ffd04b" background-color="#545c64" class="el-menu-vertical-demo"
                        ...
                        <el-sub-menu index="2">
                            ...
                            <el-menu-item v-if="this.isAuthorization == true" @click="goaddmanager" style="cursor: pointer;"
                                class="child" index="2-2">新增人員</el-menu-item>
                        </el-sub-menu>
                ...
                <el-form class="formPlace" :model="form" label-width="120px">
                    ...
                    <el-form-item label="選擇照片">
                        <div class="photoPlace">
                            <label for="file-upload" class="custom-file-upload">選擇照片</label>
                            <input id="file-upload" type="file" @change="handleFileChange">
                            <img id="addFacilityIMG" src="" ref="previewRestImg"
